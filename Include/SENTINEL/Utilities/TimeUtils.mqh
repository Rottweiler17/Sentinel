...
/// @class CTimeUtils
/// @brief Static utilities for time calculation, session checking, and bar alignment.
class CTimeUtils
{
public:
   /// @brief Evaluates current trading session and Killzone window.
   ...
   /// @brief Rounds a timestamp down to the nearest bar open time for a timeframe.
   ...
   /// @brief Checks if a new bar has opened on a specified timeframe.
